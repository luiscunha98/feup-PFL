...
% predicate to set the marble positions of the players on the board and empty spaces
init_board :-
...
% Predicate to for a computer player to play a random move
...
% Predicate to for a computer player to play a random move
play_random_move2(Player, X, Y, NewX, NewY) :-
   get_all_possible_moves(Player, Moves),
...
% Get all possible valid moves for a player
get_all_possible_moves(Player, Moves) :-
